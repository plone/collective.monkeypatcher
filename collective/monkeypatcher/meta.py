...
class IMonkeyPatchDirective(Interface):
    ...
    warndocstring = Bool(title=u"Add monkey patch warning in docstring", required=False, default=False)
...
def replace(_context, original, replacement, class_=None, module=None, handler=None,
            preservedoc=True, warndocstring=False, description=u"(No comment)", order=1000):
